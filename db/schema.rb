...
ActiveRecord::Schema.define(version: 20140925163610) do
  ...
  add_index "athletes", ["ranking_id"], name: "index_athletes_on_ranking_id", using: :btree
  ...
  add_index "teams", ["ranking_id"], name: "index_teams_on_ranking_id", using: :btree
